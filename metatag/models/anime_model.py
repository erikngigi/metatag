...
class AnimeJikanModel:
    """Handles data fetching specifically for the Jikan Anime API using httpx."""
    ...
    def fuzzy_search_anime(
        self, anime_name: str, anime_type: str, anime_status: str, page: int = 1, limit: int = 25
    ) -> Optional[AnimeSearchResponse]:
        """Queries Jikan for show data and returns multiple shows information as a list."""
        search_url = f"{self.base_url}/anime"

        params = {"q": anime_name, "type": anime_type, "status": anime_status, "page": page, "limit": limit}
        ...
        try:
            ...
            print(f"Client Error: {e.response.status_code} while quering Jikan.")
            return None
    ...
    def fetch_anime_episodes_names(
        ...
        Queries the Jikan '/amime/{anime_mal_id}/episodes' endpoint to collect the full
        ...
        try:
            ...
            print("Network Error: Jikan API is completely unreachable right now.")
            return None
